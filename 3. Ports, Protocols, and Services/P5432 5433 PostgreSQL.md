...
- **pg_stat_statements:** Provides detailed statistics on SQL query execution, useful for performance tuning.

- **pg_cron:** Allows the scheduling of PostgreSQL tasks using the cron syntax.
